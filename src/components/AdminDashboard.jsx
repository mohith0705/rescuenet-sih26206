  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 bg-slate-900 p-5 rounded-xl border border-slate-800 space-y-4">
          <div className="border-b border-slate-800 pb-3">
            <h3 className="font-bold text-white text-base flex items-center gap-2">
              <Radio className="w-5 h-5 text-red-500" /> Mass Alert Broadcast Engine
            </h3>
          ...
          <form onSubmit={handleBroadcastSubmit} className="space-y-3 text-xs">
            ...
            <button
              type="submit"
              className="w-full bg-red-600 hover:bg-red-500 text-white font-bold py-2.5 rounded-lg flex items-center justify-center gap-2 shadow-lg shadow-red-950 transition"
            >
          ...
          <div className="bg-slate-900 p-5 rounded-xl border border-slate-800 space-y-4">
            ...
            <div className="space-y-3">
              {shelters.map(shelter => (
                <div key={shelter.id} className="bg-slate-950 p-4 rounded-xl border border-slate-800 space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2 border-t border-slate-800 text-xs">
                    <div className="flex items-center justify-between bg-slate-900 p-2 rounded border border-slate-800">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button 
                          ...
                          className="bg-slate-800 hover:bg-slate-700 text-slate-200 px-1.5 py-0.5 rounded text-xs"
                        >
                          +1d
                        </button>
                      </div>
                    ...
                    <div className="flex items-center justify-between bg-slate-900 p-2 rounded border border-slate-800">
                      <span className="flex items-center gap-1 text-slate-300">
                        <HeartPulse className="w-3.5 h-3.5 text-red-400" /> Medical Doctor:
                      </span>
                      <button 
